...
public class MyBatisController {
	...
	public String m15(Model model, String column, String word) {
		...
		List<MyBatisDTO> list = dao.m15(column, map);
	...
	public String m16(Model model, MyBatisDTO dto) {
		...
		//- <where> 태그는 콘텐츠의 내용 중 "and"나 "or"로 시작하면 "and"나 "or"을 자동으로 문맥에 맞춰 삭제한다.
	...
	public String m17(Model model, MyBatisDTO dto) {
		...
		//- m17.do?seq=1&gender=f	> update tblAddress SET gender = 'f' where seq = '1'
		//- m17.do?seq=1&age=5		> update tblAddress SET age = '5' where seq = '1'
		//- m17.do?seq=1&address=서울시 강남구 역삼동 우체국 빌딩&age=6		> update tblAddress SET age = '6', address = '서울시 강남구 역삼동 우체국 빌딩' where seq = '1' 
	...
	public String m19(Model model, UserDTO udto, DetailDTO ddto) {
		...
		//- m19.do?name=아무개&email=amugae@test.com
...
//		dao.addDetail(ddto);
		...
		dao.addUser(udto);	
		ddto.setUser_seq(udto.getSeq()); //udto.getSeq()에 udto에 seq가 있다.
		dao.addDetail(ddto);
